...
var AppComponent = /** @class */ (function () {
    function AppComponent(apiService) {
        ...
        this.title = 'EMOJIFIER APPLICATION';
        this.imageUrl = '';
        this.htmlToAdd = '';
    }
    AppComponent.prototype.sendFile = function (imageUrl) {
        ...
        this.apiService.getImageData(imageUrl, function (res) {
            ...
            res.forEach(function (face) {
                ...
                var style = "position:absolute; height:" + height + "px; width:" + width + "px;\n\t\tleft:" + left + "px; top:" + top + "px";
...
module.exports = __webpack_require__(/*! C:\Users\maree\Downloads\mlh-localhost-emojifier-code-master\src\main.ts */"./src/main.ts");
